function ajaxSubmitForm(){
			    ...
			    $.ajax({
			        ...
			        success: function(html){
			            ...
			            $(".payment-details").css("float", "right").css( "width","50%");
			            $(".payment-details h1 .shipping-details h1").css("margin-left", "50px").css( "font-size","18px");
			            $(".payment-details table").css("border-bottom", "1px solid black").css( "margin-right","15px").css( "margin-left","3px").css( "border-spacing","7px 7px").css( "width","100%").css("border-collapse", "separate");
			            ...
			            $(".shipping-details table").css( "margin-left","5px").css( "border-spacing","7px 15px").css( "max-width","400px").css( "width","100% !important").css("border-collapse", "separate");
